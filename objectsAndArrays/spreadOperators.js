...
const nameOne = ['Tyler', 'Helms'];
const nameTwo = ['Jancee', 'Helms'];
...
/*
    Since the spread operator is pulling out all the items of an array, we need to make sure we use the spread operator within a new array. This is so the values that were pulled out gets placed into our new array. 

    ...arrName (if not within array, will throw error)

    - We can add to our original array wothout altering our copied array.
 ...
 */
 ...
 console.log(Math.min(...prices)); // Spread Oppulls elements out of the prices array to allow the min method to work. 
 ...
 */
 ...
 /*
        ...
        - 3 Data Types that are passed by reference: Array, Functions, and Objects
            - techinically objects.
            - non primitive variables are given reference to the value - the reference points to the location in memory. 
